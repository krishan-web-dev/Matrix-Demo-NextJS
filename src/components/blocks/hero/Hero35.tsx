...
export default function Hero35() {
  return (
    <div className="row gx-0 gy-10 gy-md-13 gy-lg-0 mt-16 mt-md-18 mb-16 mb-md-18 align-items-center text-white">
      ...
      <div className="col-lg-5">
        <h1 className="display-1 fs-80 text-uppercase text-white">
          Matrix
        </h1>
